<template>
    <div class="bg-gray-900">
        <div class="p-8 flex flex-col gap-8 text-xl md:text-2xl max-w-[1000px] mx-auto">
            <div>
            ...
            <p>
                Feel free to connect on LinkedIn or send me an <a href="mailto:sammhaider0@gmail.com" class="text-green-500 hover:text-green-600 underline">email</a> if you want to connect!
            </p>
        </div>
    </div>
</template>
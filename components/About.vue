<template>
    <div class="p-8 flex flex-col gap-8 text-xl md:text-2xl max-w-[800px] mx-auto border border-2 border-white border-t-0 border-l-0 border-r-0">
        ...
        <p>
            Feel free to get in touch on LinkedIn or send me an email if you want to connect!
        </p>
    </div>
</template>
...
const showDhaka = ref(false);
function toggleDhaka() {
    console.log("toggled")
    showDhaka.value = !showDhaka.value;
}
</script>
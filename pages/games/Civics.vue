...
const cards = ref<Card[]>([
  ...
  { q: 'What is the name of the President of the United States now?', a: 'Visit uscis.gov/citizenship/testupdates' },
  { q: 'What is the name of the Vice President of the United States now?', a: 'Visit uscis.gov/citizenship/testupdates' },
  ...
  { q: 'How many justices are on the Supreme Court?', a: 'Visit uscis.gov/citizenship/testupdates' },
  { q: 'Who is the Chief Justice of the United States now?', a: 'Visit uscis.gov/citizenship/testupdates' },
  ...
  { q: 'What is the political party of the President now?', a: 'Visit uscis.gov/citizenship/testupdates' },
  { q: 'What is the name of the Speaker of the House of Representatives now?', a: 'Visit uscis.gov/citizenship/testupdates' },

...
<template>
  <div class="p-2 bg-gradient-to-r from-cyan-200 to-teal-800">
    <div
      class="max-w-4xl mx-auto py-5 px-3 h-[100vh] flex flex-col border-1 bg-black"
    >
      <!-- Heading: Title, Rules -->
        ...
        <template v-else>
          <div class="h-45">
            <div v-if="!firstLoad" class="text-sm flex flex-col gap-2">
              ...
              Missed Words:
              <div
                class="flex gap-2 overflow-x-auto whitespace-nowrap mb-8 pb-3"
              >
                <div
          ...
          <div class="text-xl px-10 mt-4">
            <div class="instructions">
              ...
              <ul class="flex flex-col gap-2 list-disc mt-8">
                ...
                <li>
                  If you miss a word by playing the wrong letter, you lose a
                  life
                </li>
